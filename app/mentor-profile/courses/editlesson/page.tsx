            ...
            <div className="gap-4 grid mx-4 px-8 max-sm:px-2 border rounded-xl mt-8 py-8">
              ...
              <div className="grid gap-4">
                  ...
                  <div className="w-full flex max-sm:justify-between justify-end gap-3 mt-4 px-8 items-center">
                    ...
                    <button className="text-blue-600 hover:text-blue-500 active:text-blue-600 transition-all duration-150 flex gap-1"> Update <PenSquareIcon className="w-5 h-5 translate-y-px" />  </button>
                  </div>
              </div>
            </div>
